    ...
    return (
      <>
        <div className="sign-box">
          ...
          <input required className="number" type="number" value={this.state.phonenumber} onChange={this.onChange4} placeholder="phone number"></input>          <input required className="password" type="password" value={this.state.password} onChange={this.onChange5} placeholder="password"></input>
